...
// AtualizarUsuario altera/atualiza as informações de um usuário no banco de dados
...
// BuscarSeguindo traz todos os usuários que um determinado usário está seguindo
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if erro = seguranca.VerificarSenha(senhaSalvaNoBanco, senha.Atual); erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("A senha informada diverge da senha salva no banco"))
		return
	}
